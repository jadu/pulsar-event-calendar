...
$(function () {
    var calendar = new EventCalendar($('html'));
    ...
    $('.js-get-example').on('click', function () {
        var exampleDates = calendar.getDates();
        console.log(exampleDates);
    });

    $('.js-get-pattern').on('click', function () {
        var examplePattern = calendar.getRecurPattern();
        console.log(examplePattern);
    });
});

},{"./src/EventCalendar":9,"jquery":3}],2:[function(require,module,exports){
/**
 *               ~ CLNDR v1.4.7 ~
 * ==============================================
...
},{"jquery":3,"moment":7}],3:[function(require,module,exports){
/*!
...
},{"moment":7}],5:[function(require,module,exports){
...
var EventCalendar = function () {
    ...
    function EventCalendar($html) {
        ...
        this.today = (0, _moment2.default)(new Date(), this.localeFormat);
        this.datesToAdd = [];
        this.datesToDel = [];
        this.$ariaLiveRegion;
        this.$patternField;
    ...
    _createClass(EventCalendar, [{
        ...
        value: function init() {
            ...
            var $container = _self.$html.find('.js-event-calendar');
            ...
            if (typeof options.startDateField !== 'undefined' && options.startDateField.length) {
                ...
                var startDate = typeof options.startDate !== 'undefined' ? options.startDate : _self.today.format(_self.localeFormat);
                ...
                _self.$startDateField.val((0, _moment2.default)(options.startDate, _self.dateFormatInternal).format(_self.localeFormat));
            }
            ...
            if (typeof options.endDateField !== 'undefined' && options.endDateField.length) {
                ...
                var _startDate = typeof options.startDate !== 'undefined' ? options.startDate : _self.today.format(_self.localeFormat);

                options.endDate = _self.$endDateField.val().length ? _self.internalDate(_self.$endDateField.val()) : (0, _moment2.default)(_startDate, _self.dateFormatInternal).add(15, 'years').format(_self.dateFormatInternal);
            ...
            if (typeof options.endDate !== 'undefined' && typeof options.startDate !== 'undefined' && (0, _moment2.default)(options.endDate, _self.dateFormatInternal).isBefore((0, _moment2.default)(options.startDate, _self.dateFormatInternal).format(_self.dateFormatInternal))) {
            ...
            if (options.endDate !== 'Invalid date' && typeof options.endDate !== 'undefined') {
                ...
                options.endDate = (0, _moment2.default)(new Date(), _self.dateFormatInternal).add(15, 'years').format(_self.dateFormatInternal);
            }
            ...
            if (typeof options.datesToAdd !== 'undefined' && options.datesToAdd.length) {
                _jquery2.default.each(options.datesToAdd, function () {
                    var dateToAdd = (0, _moment2.default)(this, _self.dateFormatInternal),
                        startDate = (0, _moment2.default)(options.startDate, _self.dateFormatInternal),
                        endDate = (0, _moment2.default)(options.endDate, _self.dateFormatInternal);
            ...
            if (typeof options.datesToDel !== 'undefined' && options.datesToDel.length) {
                _jquery2.default.each(options.datesToDel, function () {
                    var dateToDel = (0, _moment2.default)(this, _self.dateFormatInternal),
                        endDate = (0, _moment2.default)(options.endDate, _self.dateFormatInternal);
            ...
            var clndrSelected = options.startDate ? _self.internalDate(options.startDate) : _self.today.format(_self.dateFormatInternal),
            ...
            var precompiledTemplate = _.template(clndrTemplate);
            ...
            _self.clndr = $container.clndr({
                ...
                selectedDate: (0, _moment2.default)(clndrSelected, _self.dateFormatInternal),
                showAdjacentMonths: false,
                render: function render(data) {
                    // monthNumerical is used to create the data-day attribute on day buttons
                    data.monthNumerical = (0, _moment2.default)().month(data.month).format('MM');
                ...
                startWithMonth: (0, _moment2.default)(clndrStart, _self.dateFormatInternal)
            });
            ...
            _self.$html.find('[name="ercal-weekdays"]:checked').map(function () {
                _self.originalWeekdays.push((0, _jquery2.default)(this).val());
            });
            ...
            if (_self.clndr.options.extras.datesToAdd.length || _self.clndr.options.extras.datesToDel.length) {
                _self.paintMonth((0, _moment2.default)(clndrSelected, _self.dateFormatInternal));
            }
        ...
        value: function applyPattern() {
            ...
            if (typeof _self.$endDateFieldContainer !== 'undefined') {
                if (pattern === '1day') {
                    ...
                    _self.$endDateField.val((0, _moment2.default)(_self.originalEndDate, _self.dateFormatInternal).format(_self.localeFormat)).attr('disabled', true).trigger('change').val('');
            ...
            if (pattern === 'weekly' || pattern === 'fortnight') {
                ...
                if (!_self.originalWeekdays.length) {
                    var day = (0, _moment2.default)(_self.clndr.options.constraints.startDate, _self.dateFormatInternal).day(),
                        dayNo = day != 0 ? day : 7;
        ...
        key: 'localiseWeekday',
        value: function localiseWeekday() {
            var _self = this,
                locale = _moment2.default.locale();

            if (locale === 'en' || locale === 'en-us') {
                var lastDay = _self.$weekdayPicker.find('label').last();
        ...
        key: 'toggleWeekday',
        value: function toggleWeekday() {
            var _self = this,
                pattern = _self.$patternField.val(),
                weekdays = [];

            _self.$html.find('[name="ercal-weekdays"]:checked').map(function () {
                weekdays.push((0, _jquery2.default)(this).val());
            });
        ...
        key: 'toggleDay',
        value: function toggleDay(target) {
            var _self = this,
                $elem = (0, _jquery2.default)(target.element),
                date = target.date,
            ...
            // If a date is not already selected
                    ...
                    // If the button is currently [4. To Delete]
                        ...
                        else if (!$elem.hasClass('event-add') && !$elem.hasClass('event-del') && !$elem.hasClass('selected')) {
                                // Set it to [3. To Add]
        ...
        key: 'setPattern',
        value: function setPattern(pattern, weekdays) {
            var _self = this,
                selectedDate = (0, _moment2.default)(_self.clndr.options.constraints.startDate, _self.dateFormatInternal),
                newPattern = void 0;
            ...
            switch (pattern) {
                ...
                case 'fortnight':
                    ...
                    break;
                case 'monthByDay':
                    newPattern = selectedDate.recur().every(selectedDate.day()).daysOfWeek().every(selectedDate.monthWeekByDay()).weeksOfMonthByDay();
                    break;
                case 'monthByDate':
        ...
        key: 'paintRepeatPattern',
        value: function paintRepeatPattern(method) {
            var _self = this,
                paintMethod = method ? method : 'repeat-on',
                repeatEnd = (0, _moment2.default)(_self.clndr.options.constraints.endDate, _self.dateFormatInternal).isBefore(_self.clndr.intervalEnd) ? _self.clndr.options.constraints.endDate : (0, _moment2.default)(_self.clndr.intervalEnd).format(_self.dateFormatInternal),
                recurDatesThisMonth = [];
            ...
            if (_self.$patternField.val() === 'fortnight') {
                var weeks = [],
                    fortnightlyWeeks = _self.clndr.options.selectedDate.startOf('week').recur().every(2).weeks().startDate(_self.clndr.options.selectedDate).endDate(repeatEnd).all(),
                    datesToPaint = _self.recurPattern.startDate(_self.clndr.options.constraints.startDate).endDate(repeatEnd).all();

                // Build an array of week numbers which hit the `every 2 weeks` pattern
                _jquery2.default.each(fortnightlyWeeks, function () {
                    weeks.push(this.week());
                });

                // Grab weekly recurrence and use the ones that match the required week numbers
                _jquery2.default.each(datesToPaint, function () {
                    if (_jquery2.default.inArray(this.week(), weeks) !== -1) {
                        recurDatesThisMonth.push(this);
                    }
                });
            } else {
                recurDatesThisMonth = _self.recurPattern.startDate(_self.clndr.options.constraints.startDate).endDate(repeatEnd).all();
            }

            _jquery2.default.each(recurDatesThisMonth, function () {
                switch (paintMethod) {
                    case 'repeat-on':
        ...
        key: 'paintMonth',
        value: function paintMonth(month, method) {
            var _self = this,
            ...
            if (_self.clndr.options.extras.datesToAdd.length) {
                var datesToAdd = _self.clndr.options.extras.datesToAdd.filter(EventCalendar.isInYear.bind(this, month)).filter(EventCalendar.isInMonth.bind(this, month));
            ...
            if (_self.clndr.options.extras.datesToDel.length) {
                var datesToDel = _self.clndr.options.extras.datesToDel.filter(EventCalendar.isInYear.bind(this, month)).filter(EventCalendar.isInMonth.bind(this, month));
        ...
        key: 'styleToAdd',
        value: function styleToAdd(target) {
            var _self = this,
            ...
            $elem.attr('aria-label', ariaLabel).parent().addClass('event-add');
        ...
        value: function updateLiveRegion(message) {
            var _self = this;
        ...
        key: 'styleToDel',
        value: function styleToDel(target) {
            var _self = this,
                $elem = _self.clndr.element.find('[data-day="' + target.format(_self.dateFormatInternal) + '"]'),
                ariaLabel = 'Removed. Event will no longer repeat on ' + target.format(_self.dateFormatLong);

            $elem.attr('aria-label', ariaLabel).parent().removeClass('event-add').addClass('event-del');
        ...
        key: 'styleRepeatOn',
        value: function styleRepeatOn(target) {
            var _self = this,
                $elem = _self.clndr.element.find('[data-day="' + target.format(_self.dateFormatInternal) + '"]');

            $elem.attr('aria-label', 'Event will repeat on ' + target.format(_self.dateFormatLong) + ' based on the chosen repeat pattern').parent().addClass('event-repeat');
        }
        ...
        key: 'styleClear',
        value: function styleClear(target) {
            var _self = this,
                $elem = _self.clndr.element.find('[data-day="' + target.format(_self.dateFormatInternal) + '"]');

            $elem.attr('aria-label', target.format(_self.dateFormatLong) + '.').parent().removeClass('event-add event-del event-repeat');
        ...
        key: 'styleClearAll',
        value: function styleClearAll(target) {
            var _self = this,
            ...
            $elems.each(function () {
                var $elem = (0, _jquery2.default)(this),
                    ...
                    date = (0, _moment2.default)($elem.data('day'), _self.dateFormatInternal).format(_self.dateFormatLong),
        ...
        value: function resetCalendar() {
            ...
            if (_self.originalDatesToAdd.length) {
                _self.clndr.options.extras.datesToAdd = [].concat(_toConsumableArray(_self.originalDatesToAdd));
            }

            _self.clndr.options.extras.datesToDel.length = 0;

            if (_self.originalDatesToDel.length) {
                _self.clndr.options.extras.datesToDel = [].concat(_toConsumableArray(_self.originalDatesToDel));
            }

            // Set the `selectedDate` to match the new start date
            _self.clndr.options.selectedDate = (0, _moment2.default)(_self.originalStartDate, _self.dateFormatInternal);

            // Reset start date to original value
            _self.clndr.options.constraints.startDate = _self.originalStartDate;

            if (typeof _self.$startDateField !== 'undefined') {
                _self.$startDateField.val((0, _moment2.default)(_self.originalStartDate, _self.dateFormatInternal).format(_self.localeFormat));
            }
            ...
            if (typeof _self.$endDateField !== 'undefined') {
                if (_self.originalEndDate != (0, _moment2.default)(new Date(), _self.dateFormatInternal).add(15, 'years').format(_self.dateFormatInternal)) {
                    _self.$endDateField.val((0, _moment2.default)(_self.originalEndDate, _self.dateFormatInternal).format(_self.localeFormat));
                } else {
            ...
            if (_self.originalPattern === 'weekly' && _self.originalWeekdays.length) {
                _jquery2.default.each(_self.originalWeekdays, function () {
        ...
        key: 'changeStartDate',
        value: function changeStartDate() {
            var _self = this,
                datesToAdd = _self.clndr.options.extras.datesToAdd,
                datesToDel = _self.clndr.options.extras.datesToDel,
                newStartDate = _self.$startDateField.val().length ? _self.$startDateField.val() : _self.originalStartDate,
                newStartDateMoment = (0, _moment2.default)(newStartDate, _self.localeFormat);

            // Set the `selectedDate` to match the new start date
            _self.clndr.options.selectedDate = newStartDateMoment;

            // Make dates before the new start date inactive
            _self.clndr.options.constraints.startDate = (0, _moment2.default)(newStartDate, _self.localeFormat).format(_self.dateFormatInternal);

            // Navigate to the month/year for the new start date
            _self.clndr.setYear(newStartDateMoment.year()).setMonth(newStartDateMoment.month()).render();
            ...
            var outOfBoundsDatesToAdd = _self.clndr.options.extras.datesToAdd.filter(EventCalendar.isInYear.bind(this, newStartDateMoment)).filter(EventCalendar.isInMonth.bind(this, newStartDateMoment)).filter(EventCalendar.isBeforeDate.bind(this, newStartDateMoment));

            _jquery2.default.each(outOfBoundsDatesToAdd, function (k, v) {
            ...
            var outOfBoundsDatesToDel = _self.clndr.options.extras.datesToDel.filter(EventCalendar.isInYear.bind(this, newStartDateMoment)).filter(EventCalendar.isInMonth.bind(this, newStartDateMoment)).filter(EventCalendar.isBeforeDate.bind(this, newStartDateMoment));

            _jquery2.default.each(outOfBoundsDatesToDel, function (k, v) {
        ...
        key: 'changeEndDate',
        value: function changeEndDate() {
            var _self = this,
                datesToAdd = _self.clndr.options.extras.datesToAdd,
                datesToDel = _self.clndr.options.extras.datesToDel,
                newEndDate = _self.$endDateField.val().length ? _self.$endDateField.val() : (0, _moment2.default)(new Date(), _self.dateFormatInternal).add(15, 'years').format(_self.localeFormat),
                newEndDateMoment = newEndDate.length ? (0, _moment2.default)(newEndDate, _self.localeFormat) : (0, _moment2.default)(new Date(), _self.dateFormatInternal).add(15, 'years');

            // Update the endDate constraint before re-rendering
            _self.clndr.options.constraints.endDate = (0, _moment2.default)(newEndDate, _self.localeFormat).format(_self.dateFormatInternal);

            // Remove now out-of-bounds dates from the datesToAdd array
            var outOfBoundsDatesToAdd = _self.clndr.options.extras.datesToAdd.filter(EventCalendar.isInYear.bind(this, newEndDateMoment)).filter(EventCalendar.isInMonth.bind(this, newEndDateMoment)).filter(EventCalendar.isAfterDate.bind(this, newEndDateMoment));
            ...
            // Remove now out-of-bounds dates from the datesToDel array
            var outOfBoundsDatesToDel = _self.clndr.options.extras.datesToDel.filter(EventCalendar.isInYear.bind(this, newEndDateMoment)).filter(EventCalendar.isInMonth.bind(this, newEndDateMoment)).filter(EventCalendar.isAfterDate.bind(this, newEndDateMoment));
        ...
        key: 'setEndDateMinimum',
        value: function setEndDateMinimum() {
            var _self = this,
        ...
        key: 'setStartDateMaximum',
        value: function setStartDateMaximum() {
            var _self = this,
        ...
        key: 'getRecurPattern',
        value: function getRecurPattern() {
            var _self = this;
        ...
        key: 'internalDate',
        value: function internalDate(date) {
            var _self = this;
            ...
            if ((0, _moment2.default)(date, _self.dateFormatInternal, true).isValid()) {
                return date;
            }

            // Return `today` if no date is provided
            if (typeof date === 'undefined' || !date.length) {
                return (0, _moment2.default)(_self.today, _self.dateFormatInternal).format(_self.localeFormat);
            }

            // Otherwise, reformat the date
            return (0, _moment2.default)(date, _self.localeFormat).format(_self.dateFormatInternal);
        }
        ...
        key: 'pluralise',
        value: function pluralise(noun, quantity) {
        ...
        key: 'isBeforeDate',
        value: function isBeforeDate(dateToCompareTo, date) {
        ...
        key: 'isAfterDate',
        value: function isAfterDate(dateToCompareTo, date) {
            return date.date() > dateToCompareTo.date();
        }
        ...
        key: 'isInMonth',
        value: function isInMonth(dateToCompareTo, date) {
        ...
        key: 'isInYear',
        value: function isInYear(dateToCompareTo, date) {
        ...
        key: 'doesNotMatchDate',
        value: function doesNotMatchDate(a, b) {
...
},{"clndr":2,"jquery":3,"moment":7,"moment-recur":4,"moment/locale/en-au":5,"moment/locale/en-gb":6,"underscore":8}]},{},[1]);
